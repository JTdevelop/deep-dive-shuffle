...
public class ArrayShuffles {
  ...
  /**
   * Shuffles deck with default source of randomness. 
   * Invokes {@link#shuffle(int[], Random)}.
   * 
 ...
 /**
  * Shuffles deck with default source of randomness. 
  * Invokes {@link#shuffle(long[], Random)}.
  * 
  * @param deck data array. 
  * 
  */
 ...
 /**
  * Shuffles deck with default source of randomness. 
  * Invokes {@link#shuffle(boolean[], Random)}.
  * 
  * @param deck data array. 
  * 
  */
 ...
 /**
  * Shuffles deck with default source of randomness. 
  * Invokes {@link#shuffle(short[], Random)}.
  * 
  * @param deck data array. 
  * 
  */
 ...
 /**
  * Shuffles deck with default source of randomness. 
  * Invokes {@link#shuffle(char[], Random)}.
  * 
  * @param deck data array. 
  * 
  */
 ...
 /**
  * Shuffles deck with default source of randomness. 
  * Invokes {@link#shuffle(float[], Random)}.
  * 
  * @param deck data array. 
  * 
  */
 ...
 /**
  * Shuffles deck with default source of randomness. 
  * Invokes {@link#shuffle(double[], Random)}.
  * 
  * @param deck data array. 
  * 
  */
